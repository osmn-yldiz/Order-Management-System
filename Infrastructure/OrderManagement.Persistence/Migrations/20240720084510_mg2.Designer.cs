            ...
            modelBuilder.Entity("OrderManagement.Domain.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 7, 20, 8, 45, 9, 625, DateTimeKind.Utc).AddTicks(3021),
                            Description = "Bu bir örnek şirkettir",
                            LastUpdateDate = new DateTime(2024, 7, 20, 8, 45, 9, 625, DateTimeKind.Utc).AddTicks(3022),
                            Name = "Örnek Şirket",
            ...
            modelBuilder.Entity("OrderManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 7, 20, 8, 45, 9, 626, DateTimeKind.Utc).AddTicks(9801),
                            LastUpdateDate = new DateTime(2024, 7, 20, 8, 45, 9, 626, DateTimeKind.Utc).AddTicks(9801),
                            Name = "Örnek Sipariş",
                            OrderCount = 5,
                            OrderStatus = 0,
            ...
            modelBuilder.Entity("OrderManagement.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("9450a960-4f4c-4967-84c7-1e9f5781dd00"),
                            CreatedDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(5555),
                            Description = "Bu bir örnek üründür",
                            LastUpdateDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(5555),
                            Name = "Örnek Ürün",
                            Price = 50.0m,
            ...
            modelBuilder.Entity("OrderManagement.Domain.Entities.ProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(1277),
                            Description = "Bu bir örnek kategoridir",
                            LastUpdateDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(1278),
                            Name = "Örnek Kategori"
                        });
                });
            ...
            modelBuilder.Entity("OrderManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(7059),
                            Description = "Bu bir örnek kullanıcıdır",
                            Email = "Test@gmail.com",
                            FirstName = "Test",
                            LastName = "Test",
                            LastUpdateDate = new DateTime(2024, 7, 20, 8, 45, 9, 627, DateTimeKind.Utc).AddTicks(7059),
